...
private val logger = LoggerFactory.getLogger("EmbeddingCache")
...
object EmbeddingCache {
    ...
    fun load(
        ...
        val root = try {
            json.decodeFromString<CacheRoot>(cacheFile.readText())
        } catch (e: Exception) {
    ...
    fun save(
        ...
        runCatching {
            ...
            File(cacheFilePath).writeText(json.encodeToString(CacheRoot.serializer(), root))
