...
company: "МРС (Мобильные решения для строительства)"
title: "Tech Lead / Architect"
cv_description: "Ключевой технический decision-maker low-code платформы (10+ сервисов) в IT-компании строительного сектора. Команда 7–14 чел., на базе платформы 4–6 продуктов (2–3 в активной эксплуатации). Проектировал архитектуру, внедрил Kotlin Multiplatform для общей бизнес-логики JVM/JS. Новые сервисы строились на Ktor + Exposed — выбор обоснован меньшим временем запуска и потреблением памяти по сравнению со Spring Boot + Hibernate. Возглавлял R&D-направление."
---
